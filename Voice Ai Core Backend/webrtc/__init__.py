...
# ================================================================
#
# webrtc * DEPRECATED aiortc WebRTC layer stub
#   |
#   |----> [DEPRECATED] * Replaced by backend/livekit/
#   |
#   |----> utils * Still active — imported by livekit/
#           |
#           |----> wav_bytes_to_pcm() * WAV bytes to PCM
#           |
#           |----> resample_audio() * Audio sample rate convert
#           |
#           |----> float32_to_int16() * Float to int16 PCM
#
# ================================================================
"""
backend/webrtc
