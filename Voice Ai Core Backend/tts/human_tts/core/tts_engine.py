...
#    |
#    |----> <AutoTokenizer> -> from_pretrained()  (prompt)
#    |
#    |----> <AutoTokenizer> -> from_pretrained()  (description)
#
#    |
#    v
# +-------------------------------+
...
# +-------------------------------+
#    |
#    |----> _clean_text() * sanitize input — removes strange chars
#    |
#    |----> <PersonaManager> -> guard() * language voice guardrail
#    |
#    |----> <PersonaManager> -> get_or_encode()
#    |      * cached named-speaker description tensor
#    |
